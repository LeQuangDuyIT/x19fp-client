      ...
      <div className='bg-white w-auto text-center rounded h-[200px] px-14 py-4 shadow-user-profile '>
        <div className='mb-2 relative '>
          ...
          <label htmlFor='file-upload' className='cursor-pointer'>
            <div className='absolute right-0 bottom-0 border-slate-400 border-2 text-center flex  items-center rounded-full p-2 align-middle content-center bg-gray-200 z-1 hover:bg-gray-300 '>
